        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          ...
          <div class="space-y-8">
            ...
            <p class="text-xl md:text-2xl text-gray-700 font-light leading-relaxed">
              {{ productDetail.benefits && productDetail.benefits[productDetail.benefits.length - 1] }}
            </p>
          ...
          <div class="space-y-6">
            ...
            <!-- 功效关键词 -->
            <div v-if="productDetail.keywords" class="flex flex-wrap gap-3">
              <span
                v-for="(keyword, index) in productDetail.keywords"
                :key="keyword"
                class="px-3 py-1 text-gray-700 text-sm font-medium border border-gray-300 rounded-full hover:border-gray-900 hover:text-gray-900 transition-all cursor-pointer"
              >
                {{ keyword }}
              </span>
            </div>
